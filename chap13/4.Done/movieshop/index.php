...
<p align="center"><a href="add.php">新增記錄</a></p>
<table width="846" border="1" align="center" cellpadding="1" cellspacing="1">
  <tr class="columntitle">
    <td width="95" align="center"><strong>片名</strong></td>
    <td width="121" align="center"><strong>導演</strong></td>
    <td width="194" align="center"><strong>演員</strong></td>
  ...
  <?php do { ?>
      <?php if ($totalRows_rs_movie > 0) { // Show if recordset not empty ?>
        <tr>
          <td><a href="detail.php?ID=<?php echo $row_rs_movie['id']; ?>"><?php echo $row_rs_movie['title']; ?></a></td>
