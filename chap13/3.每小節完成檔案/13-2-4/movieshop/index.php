...
<p align="center"><a href="<?php printf("%s?pageNum_rs_movie=%d%s", $currentPage, 0, $queryString_rs_movie); ?>">&lt;第一頁&gt;</a><a href="<?php printf("%s?pageNum_rs_movie=%d%s", $currentPage, max(0, $pageNum_rs_movie - 1), $queryString_rs_movie); ?>">&lt;上一頁&gt;</a><a href="<?php printf("%s?pageNum_rs_movie=%d%s", $currentPage, min($totalPages_rs_movie, $pageNum_rs_movie + 1), $queryString_rs_movie); ?>">&lt;下一頁&gt;</a><a href="<?php printf("%s?pageNum_rs_movie=%d%s", $currentPage, $totalPages_rs_movie, $queryString_rs_movie); ?>">&lt;最後一頁&gt;</a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>
</body>
